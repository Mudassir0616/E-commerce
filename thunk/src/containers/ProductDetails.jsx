...
const ProductDetails = () => {
  ...
  const myPic = product?.allProducts?.selectedproducts?.thumbnail;
      ...
      <div className="one-container">
        <div className="oneProduct">
          ...
          <div className="one-img">
            <img
              src={image.length > 0 ? image : myPic}
              style={{ width: "350px" }}
            />
          </div>
          ...
          <div className="one-det">
            ...
            >
              {product?.allProducts?.selectedproducts?.title} <br />
              <span
                style={{
                  fontSize: "19px",
                  fontWeight: "400",
              ...
              >
                ({product?.allProducts?.selectedproducts?.category})
              </span>
            </p>
            <h3>
              <span style={{ color: "#cd9042" }}>
                &#9733; {product?.allProducts?.selectedproducts?.rating}
              </span>
            </h3>

            <p style={{ fontSize: "19px", fontWeight: "500" }}>
              {product?.allProducts?.selectedproducts?.description}. Only{" "}
              <span style={{ color: "#cd9042" }}>
            ...
            <div
              style={{ fontSize: "31px", fontWeight: "600", margin: "20px 0" }}
            >
              $
              {Math.round(
                product?.allProducts?.selectedproducts?.price -
                  product?.allProducts?.selectedproducts?.price /
                    product?.allProducts?.selectedproducts?.discountPercentage
              )}
              <span
                style={{
                  color: "gray",
